...
export class RollupCampaignHour {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @Column({ name: 'stat_hour', type: 'timestamp' })
  statHour: string;
  ...
  @JoinColumn({
    name: 'publisher_id',
    foreignKeyConstraintName: 'fk_rollup_hour_publisher',
  })
  publisher: Client;
  ...
  @JoinColumn({
    ...
    foreignKeyConstraintName: 'fk_rollup_hour_traffic_source',
  })
  ...
  @JoinColumn({
    name: 'advertiser_id',
    foreignKeyConstraintName: 'fk_rollup_hour_advertiser',
  })
  advertiser: Client;
  ...
  @JoinColumn({
    name: 'campaign_id',
    foreignKeyConstraintName: 'fk_rollup_hour_campaign',
  })
  campaign: Campaign;
  ...
  @JoinColumn({
    name: 'lander_id',
    foreignKeyConstraintName: 'fk_rollup_hour_lander',
  })
  lander: Lander;
}
